...
function parseDownloadName(contentDisposition: string | null) {
...
export const apiClient = {
  async fetchInpx(magnetUri: string, onProgress?: (progress: { downloadedBytes: number; totalBytes: number | null; percent: number | null }) => void) {

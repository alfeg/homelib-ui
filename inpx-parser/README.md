...
- The parser is synchronous and loads the entire archive into memory. For very large INPX files (~35 MB), running it inside a Web Worker is strongly recommended to avoid blocking the main thread.
